...
You can override this plugin's default styles by adding a `textMarkers` object to the `styleOverrides` engine config option. You can find a list of all [overridable styles](#available-styleoverrides) below.
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``['32%', '75%'] // 32% for dark themes, 75% for light themes``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<defaultLuminance> <defaultChroma> <delHue> / <backgroundOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<borderLuminance> <defaultChroma> <delHue> / <borderOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<indicatorLuminance> <defaultChroma> <delHue> / <indicatorOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``['67%', '40%'] // 67% for dark themes, 40% for light themes``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<defaultLuminance> <defaultChroma> <insHue> / <backgroundOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<borderLuminance> <defaultChroma> <insHue> / <borderOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<indicatorLuminance> <defaultChroma> <insHue> / <indicatorOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<defaultLuminance> <defaultChroma> <markHue> / <backgroundOpacity>)``
...
> Type: [UnresolvedStyleValue](/reference/style-overrides/#unresolvedstylevalue)\
> Default: ``lch(<borderLuminance> <defaultChroma> <markHue> / <borderOpacity>)``
