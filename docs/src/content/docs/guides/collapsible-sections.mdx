...
You can override this plugin's default styles by adding a `collapsibleSections` object to the `styleOverrides` engine config option. You can find a list of all [overridable styles](#available-styleoverrides) below.
