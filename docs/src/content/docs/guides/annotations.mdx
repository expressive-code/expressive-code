...
<Tabs>
  <TabItem label="Astro">
    The following example shows how to configure `astro-expressive-code` in Astro:
  ...
  <TabItem label="Next.js">
    The following example shows how to configure `remark-expressive-code` in Next.js:
