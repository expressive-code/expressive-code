...
- By providing a [`styleSettings`](#stylesettings-pluginstylesettings) property in the plugin object returned by the plugin's initialization function, which will be used to generate CSS variables automatically.
