...
> Type: (theme) => void \| [ExpressiveCodeTheme](/api/expressive-code/core/classes/expressivecodetheme/)\
> Default: `undefined`
...
> Type: [ExpressiveCodeTheme](/api/expressive-code/core/classes/expressivecodetheme/)
