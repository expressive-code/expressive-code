...
2. Install the latest version of `astro-expressive-code`:
    ...
    <Tabs>
      ...
      <TabItem label="pnpm">
      ```sh
      pnpm i astro-expressive-code@latest
      ```
      </TabItem>
      <TabItem label="yarn">
      ```sh
      yarn add astro-expressive-code@latest
      ```
      </TabItem>
    </Tabs>
...
2. Install the latest version of `remark-expressive-code`:
    ...
    <Tabs>
      <TabItem label="npm">
      ```sh
      npm i remark-expressive-code@latest
      ```
      </TabItem>
      <TabItem label="pnpm">
      ```sh
      pnpm i remark-expressive-code@latest
      ```
      </TabItem>
      <TabItem label="yarn">
      ```sh
      yarn add remark-expressive-code@latest
      ```
      </TabItem>
    </Tabs>
