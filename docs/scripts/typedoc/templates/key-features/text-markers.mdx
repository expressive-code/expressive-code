...
:::tip
If you want to use longer labels and they start to overlap with your code, consider increasing the core style setting [`codePaddingInline`](/reference/style-overrides/#codepaddinginline).
:::
